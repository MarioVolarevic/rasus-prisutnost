...
namespace Attassa
{
    ...
    public class OAuthLinkedIn : oAuthBase
    {
        ...
        private string _consumerKey = "oiw2lq3rtc4v";
        private string _consumerSecret = "52FCaFCOfvMfvGRX";
        ...
        public const string CALLBACK = "http://localhost:49826/Aplikacija_pracenje_prisutnosti/LinkedInTable.aspx";
